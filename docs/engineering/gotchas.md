...
- staging integration 的 512 MiB transient cgroup 同时容纳 Maven 主 JVM 与 Failsafe fork；本地/CI 门禁已运行 PMD，因此 `staging-integration` profile 应跳过 PMD，并将 Failsafe fork heap 限在 128 MiB，给 JVM native/metaspace 留出空间。
