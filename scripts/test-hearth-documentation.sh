...
for decision in 0001-unified-identity-and-authorization-boundary 0002-oidc-oauth2-application-integration 0003-use-mature-identity-provider 0004-isolated-identity-environments-and-stable-subject; do
...
if rg -n -i 'bytedepth-start|BYTEDEPTH_' "$SOURCE_ROOT/deploy" "$SOURCE_ROOT/Dockerfile"; then
