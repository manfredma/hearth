...
! grep -Fq 'systemd-run --scope' "$ROOT/deploy/run-staging-e2e-tests.sh" "$ROOT/deploy/run-staging-integration-tests.sh"
grep -Fq -- '--unit="hearth-staging-e2e-' "$ROOT/deploy/run-staging-e2e-tests.sh"
grep -Fq -- '--unit="hearth-staging-integration-' "$ROOT/deploy/run-staging-integration-tests.sh"
grep -Fq -- '--collect' "$ROOT/deploy/run-staging-e2e-tests.sh"
grep -Fq -- '--collect' "$ROOT/deploy/run-staging-integration-tests.sh"
grep -Fq -- '--expand-environment=no' "$ROOT/deploy/run-staging-e2e-tests.sh"
grep -Fq -- '--expand-environment=no' "$ROOT/deploy/run-staging-integration-tests.sh"
grep -Fq -- '--pipe --property=MemoryMax=512M' "$ROOT/deploy/run-staging-e2e-tests.sh"
grep -Fq -- '--pipe --property=MemoryMax=512M' "$ROOT/deploy/run-staging-integration-tests.sh"
